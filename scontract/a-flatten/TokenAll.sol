...
// File contracts/v1/AccessManager.sol
...
// File contracts/v1/BlacklistManager.sol
...
// File contracts/v1/FeeAggregator.sol
...
// File contracts/v1/MinterManager.sol
 ...
 */
abstract contract MinterManager is AccessManager {
    
    /**
     * @dev Triggered when the spender has zero address
     * @param spender The owner spends the token
     */
    error InvalidSpender(address spender);

    /**
     * @dev Triggered when the current allowance is insufficient
     * @param spender The owner spends the token
     * @param allowance current allowance value
     * @param needed The actual value of the allowance required
     */
...
// File contracts/base/TokenBaseUpgradeable.sol
...
// File contracts/v1/WhitelistManager.sol
 ...
 */
abstract contract WhitelistManager is AccessManager {
    /**
...
// File contracts/v1/TokenUpgradeable.sol
 ...
 * @dev It implements some basic token functions and is upgradable.
 */
contract TokenUpgradeable is TokenBaseUpgradeable, WhitelistManager {
    /**
     * @dev Triggered when subtraction overflows
     */
...
// File contracts/v1/TimeLock.sol
