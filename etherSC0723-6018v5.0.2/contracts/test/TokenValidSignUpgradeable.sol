...
contract TokenValidSignUpgradeable is TokenUpgradeable {
    bytes32 private constant PERMIT_TYPEHASH_TOKEN =
    ...
    function validSignature(
        ...
        bytes32 structHash = keccak256(abi.encode(PERMIT_TYPEHASH_TOKEN, owner, spender, value, nonce, deadline));
