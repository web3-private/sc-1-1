...
async function main() {
  ...
  console.log("Token Name:", process.env.tokenName);
  console.log("Token Symbol:", process.env.tokenSymbol);
  console.log("Token Decimals:", process.env.tokenDecimals);
  // const instance: Contract = null;
  // try {
  //   instance = await upgrades.deployProxy(TokenUpgradeable1, [
  //     process.env.owner,
