...
//         require(_newPauser != address(0), "TokenUpgradeable: new pauser is the zero address");
//         pauser = _newPauser;
...
//         require(newRescuer != address(0), "TokenUpgradeable: new rescuer is the zero address");
//         _rescuer = newRescuer;
...
//     function _setWhitelistState(address _account, bool _shouldWhitelist) internal {
...
//      */
//     function setParams(uint newBasisPoints, uint newMaxFee) external override onlyOwner returns (bool) {
...
//     ) public whenNotPaused onlyOwner isAddressWhitelisted(feeAccount) isAddressWhitelisted(msg.sender) returns (bool) {
...
//         bytes memory orderId
//     ) external whenNotPaused onlyOwner isAddressWhitelisted(feeAccount) isAddressWhitelisted(from) {
...
//      */
//     function _requireValidSignature(address signer, bytes32 dataHash, bytes memory signature) internal view override {
//         require(
