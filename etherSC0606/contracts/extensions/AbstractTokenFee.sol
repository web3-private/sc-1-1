...
abstract contract AbstractTokenFee {
    ...
    function setParams(uint256 newBasisPoints, uint256 newMaxFee) external virtual returns (bool);
    ...
    function setAccountBasisPointsRate(address account, uint256 newBasisPoints) external virtual returns (bool) {
