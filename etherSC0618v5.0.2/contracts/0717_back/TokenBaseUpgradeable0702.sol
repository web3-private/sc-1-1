...
import {Minterable0702} from "./Minterable0702.sol";

import {FeeV1Interface0702} from "./interfaces/FeeV1Interface0702.sol";
import {FeeAggregator0702} from "./interfaces/FeeAggregator0702.sol";

contract TokenBaseUpgradeable0702 is
    Initializable,
    ERC20Upgradeable,
    ...
    FeeAggregator0702
{
    ...
    function initialize(address initialOwner, string memory name_, string memory symbol_) public initializer {
        ...
        _grantRole(WHITELISTER_ROLE, initialOwner);
        ...
        _grantRole(FEE_HOLDER_ROLE, initialOwner);
    ...
    function approveMint(
        ...
        super._approve(account, minter, amount);
        return true;
    }
    ...
    function updateAllowance(address owner, address minter, uint256 amount) internal override returns (bool) {
        super._spendAllowance(owner, minter, amount);
        return true;
    }
