...
import {TokenAccessControlUpgradeable} from "./TokenAccessControlUpgradeable.sol";

import {Strings} from "@openzeppelin/contracts/utils/Strings.sol";
import {AccessManager0710} from "./AccessManager0710.sol";
import {Minterable0710} from "./Minterable0710.sol";

import {FeeV1Interface0710} from "./interfaces/FeeV1Interface0710.sol";
import {FeeAggregatorA} from "./interfaces/FeeAggregatorA.sol";

import {Blacklistable0710} from "./Blacklistable0710.sol";

contract TokenBaseUpgradeableTokenAccess is
    ERC20PausableUpgradeable,
    OwnableUpgradeable,
    ERC20PermitUpgradeable,
    // AccessControlUpgradeable,
    TokenAccessControlUpgradeable,
    Blacklistable0710,
    Minterable0710,
    FeeAggregatorA
{
    ...
    function updateMasterMinter(address _newMasterMinter) public virtual override onlyOwner {
        ...
        // TODO
        // MASTER_MINTER_ROLE
        //getRoleMember(MASTER_MINTER_ROLE, 0);
        super._checkRoleAccount(MASTER_MINTER_ROLE, _newMasterMinter);
        super._grantRole(MASTER_MINTER_ROLE, _newMasterMinter);
    ...
    function updateBlacklister(address _newBlacklister) public override onlyOwner {
        ...
        // MASTER_MINTER_ROLE
        // getRoleMember(MASTER_MINTER_ROLE, 0);
        super._checkRoleAccount(MASTER_MINTER_ROLE, _newBlacklister);
