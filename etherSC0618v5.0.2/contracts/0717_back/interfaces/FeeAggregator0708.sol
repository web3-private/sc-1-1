...
import {FeeV1Interface0708} from "./FeeV1Interface0708.sol";
import {TokenErrors0708} from "./TokenErrors0708.sol";

abstract contract FeeAggregator0708 is FeeV1Interface0708, OwnableUpgradeable, TokenErrors0708 {
    using Math for uint256;

    uint256 public basisPointsRate;
    uint256 public basisPointsRateDecimal = 1000;
    ...
    function _removeFeeAccount(address account) internal returns (bool) {
