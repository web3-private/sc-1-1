...
import {TokenBaseUpgradeable0726} from "./TokenBaseUpgradeable0726.sol";
import {Whitelistable0726} from "./Whitelistable0726.sol";

import {Math} from "@openzeppelin/contracts/utils/math/Math.sol";
import {SignatureChecker} from "@openzeppelin/contracts/utils/cryptography/SignatureChecker.sol";

contract TokenUpgradeable0726 is TokenBaseUpgradeable0726, Whitelistable0726 {
    ...
    function updateWhitelister(address _newWhitelister) external override onlyOwner {
        ...
        require(!isContract(_newWhitelister), "TokenUpgradeable: new whitelister is the contract");
    ...
    function incrementalMint(uint256 amount) public whenNotPaused onlyUnlock {
        require(_msgSender() == owner(), "TokenUpgradeable: _msgSender() address is not the  owner() address");
