...
async function main() {
  ...
  const TokenUpgradeable2 = await ethers.getContractFactory("TokenUpgradeableUp", deployer);
  ...
  // console.log("TokenUpgradeable2 impl  address:", TokenUpgradeable2);
  const upgraded = await upgrades.upgradeProxy(proxyAddress, TokenUpgradeable2);


  // console.log("TokenUpgradeable deployer  address:", upgraded);
