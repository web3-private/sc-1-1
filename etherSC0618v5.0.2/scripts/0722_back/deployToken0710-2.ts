...
async function setInitWhiteListerRole(instance: Contract) {
  ...
  // await managerInstance.grantRole(await instance.WHITELISTER_MANAGER_ROLE(), process.env.whitelist);
...
//   //setup BLACKLISTER_ROLE
//   await instance.grantRole(await instance.BLACKLISTER_ROLE(), process.env.blacklist);
//   console.log("grantRole BLACKLISTER_ROLE :::::", process.env.blacklist);

//   //setup WHITELISTER_ROLE
//   await instance.grantRole(await instance.WHITELISTER_ROLE(), process.env.whitelist);
//   console.log("grantRole WHITELISTER_ROLE :::::", process.env.whitelist);

//   //setup MINTER_ROLE
//   await instance.grantRole(await instance.MINTER_ROLE(), process.env.minter);
//   console.log("grantRole MINTER_ROLE      :::::", process.env.minter);

//   //setup FEE_HOLDER_ROLE
//   await instance.grantRole(await instance.FEE_HOLDER_ROLE(), process.env.feehold);
//   console.log("grantRole FEE_HOLDER_ROLE  :::::", process.env.feehold);
// }
