...
describe("TokenUpgradeable contract", function () {
  ...
  async function deployTokenUpgradeableAndWhiteFixture() {
    ...
    // instance.grantRole(PAUSER_ROLE, initialOwner);
    // instance.setRoleAdmin(PAUSER_ROLE, ADMIN_ROLE);

    // instance.grantRole(BLACKLISTER_MANAGER_ROLE, initialOwner);

    // await instance.setRoleAdmin(BLACKLISTER_ROLE, BLACKLISTER_MANAGER_ROLE);

    // await instance.grantRole(WHITELISTER_MANAGER_ROLE, initialOwner);

    // await instance.setRoleAdmin(WHITELISTER_ROLE, WHITELISTER_MANAGER_ROLE);

    // await instance.grantRole(MASTER_MINTER_ROLE, initialOwner);

    // await instance.setRoleAdmin(MINTER_ROLE, MASTER_MINTER_ROLE);

    // await instance.grantRole(FEE_MANAGER_ROLE, initialOwner);

    // await instance.setRoleAdmin(FEE_HOLDER_ROLE, FEE_MANAGER_ROLE);
