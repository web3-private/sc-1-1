...
async function setInitRoleAdmin(
  ...
  await instance.grantRole(await instance.BLACKLIST_MANAGER_ROLE(), await blacklistManager.getAddress());
  console.log("grantRole BLACKLIST_MANAGER_ROLE                 :::::", await blacklistManager.getAddress());
  ...
  await instance.grantRole(await instance.WHITELIST_MANAGER_ROLE(), await whitelistManager.getAddress());
  console.log("grantRole WHITELIST_MANAGER_ROLE                 :::::", await whitelistManager.getAddress());
...
async function setInitBlackListerRole(instance: Contract, blacklistManager: Signer, blacklist: Signer) {
  ...
  await managerInstance.grantRole(await managerInstance.BLACKLIST_MEMBER_ROLE(), await blacklist.getAddress());
  console.log("grantRole BLACKLIST_MEMBER_ROLE               :::::", await blacklist.getAddress());
}
...
async function setInitWhiteListerRole(
  ...
  await managerInstance.grantRole(await managerInstance.WHITELIST_MEMBER_ROLE(), await owner.getAddress());
  console.log("grantRole WHITELIST_MEMBER_ROLE               :::::", await owner.getAddress());

  await managerInstance.grantRole(await managerInstance.WHITELIST_MEMBER_ROLE(), await admin.getAddress());
  console.log("grantRole WHITELIST_MEMBER_ROLE               :::::", await admin.getAddress());

  await managerInstance.grantRole(await managerInstance.WHITELIST_MEMBER_ROLE(), await otherAccount.getAddress());
  console.log("grantRole WHITELIST_MEMBER_ROLE               :::::", await otherAccount.getAddress());
}
