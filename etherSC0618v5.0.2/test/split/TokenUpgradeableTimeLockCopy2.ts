  ...
  describe("TimeLock", function () {
    describe("Validations", function () {
      it("Should TimeLock status changed to true", async function () {
        ...
        // expect(await mint1(deployInstance, owner, admin, masterminter, minter1, feehold1)).to.be.revertedWith(
        //   "TimeLock: Operation not allowed yet",
        // );

        // revisit transfer. The admin account has called transfer twice
      ...
      it("Should TimeLock status changed to false by 'mint' function", async function () {
        ...
        // expect(await mint1(deployInstance, owner, admin, masterminter, minter1, feehold1)).to.be.true;
      ...
      it("Should TimeLock status changed to false by 'redeem' function", async function () {
        ...
        // console.log("minter1:::", minter1);
        // console.log("feehold1:::", feehold1);
        // redeem
        await redeem(
          deployInstance,
          owner.provider,
...
async function mint1(
  ...
  // Connect owner to the instance
  const instance = deployInstance.connect(owner) as Contract;
  console.log("await owner::", owner.getAddress());
  console.log("await admin::", admin.getAddress());
  console.log("await masterminter::", masterminter.getAddress());
  console.log("await minter1::", minter1.getAddress());
  console.log("await feehold1::", feehold1.getAddress());
  console.log("await instance.getRoleMember(::", await instance.getRoleMember(await instance.MASTER_MINTER_ROLE(), 0));
  // // console.log("await instance.getRoleMember(::",await instance.getRoleMember(await instance.MASTER_MINTER_ROLE(), 1));
  // console.log("await masterminter::", masterminter);
  // console.log("await masterminter.getAddress()::", masterminter.getAddress());
...
async function redeem(
  ...
  console.log("minter1AccountAddress::::::::::::::::::", minter1AccountAddress);
