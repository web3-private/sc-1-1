...
async function main() {
    ...
    // const value = 5432100;
    const value = ethers.parseUnits("32321", 2);
    console.log("value::", value);


    const validAfter = 1716255503; //1715750848
    const validBefore = 1716428303; //1718429248 
    ...
    const orderId = ethers.encodeBytes32String("24052200620000000001038022");
