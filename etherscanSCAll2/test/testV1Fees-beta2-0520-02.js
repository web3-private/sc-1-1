...
async function main() {
    ...
    const value = ethers.parseUnits("11112", 2);
    console.log("value::", value);


    const validAfter = 1716106382; //1715750848
    const validBefore = 1716279182; //1718429248 
    ...
    const JDSCValidSignBeta0520 = await ethers.getContractFactory("JDSCValidSignBeta0520");
    const jdscValidSignBeta0520 = await JDSCValidSignBeta0520.deploy();
    // 0x5FbDB2315678afecb367f032d93F642f64180aa3
    console.log("签名验证合约地址 jdscValidSignBeta0520 target:::", jdscValidSignBeta0520.target);
    const dd = jdscValidSignBeta0520.validSignature(
      from,
      to,
      value,
      validAfter,
    ...
    const domain_separator = await jdscValidSignBeta0520._DEPRECATED_CACHED_DOMAIN_SEPARATOR();
