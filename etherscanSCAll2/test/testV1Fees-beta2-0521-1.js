...
async function main() {
    ...
    // const value = 5432100;
    const value = ethers.parseUnits("54321", 2);
    console.log("value::", value);


    const validAfter = 1716191134; //1715750848
    const validBefore = 1716363934; //1718429248 
    // const validAfter = 1716189978; //1715750848
    // const validBefore = 1716690138; //1718429248

    const nonce = ethers.zeroPadValue(ethers.toBeHex(1), 32);
    ...
    // console.log("nonce::", ethers.encodeBytes32String("1"));
    // console.log("nonce::", ethers.zeroPadBytes(ethers.toBeHex(1), 32));
    // console.log("nonce::", ethers.zeroPadValue(ethers.toBeHex(1), 32));
    // console.log("nonce::", ethers.ZeroAddress(ethers.toBeHex(1), 32));
    // console.log("nonce::", ethers.stripZerosLeft(ethers.toBeHex(1), 32));
    
    const orderId = ethers.encodeBytes32String("24052100620000000001037520");
    // const orderId = "0x313131";
    console.log("orderId::", orderId);
    // console.log("orderId::", ethers.zeroPadBytes(ethers.toBeHex(111), 32));
    // console.log("orderId::", ethers.encodeBytes32String("111"));
